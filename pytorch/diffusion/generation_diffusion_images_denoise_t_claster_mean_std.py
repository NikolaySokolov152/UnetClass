...
model_paths = [
            "2024_03_25/model_by_config_diffusion_normal_mask_tiny_unet_v3_MSELoss_6_classes_mean_std.pt",
            "2024_03_25/model_by_config_diffusion2_normal_mask_tiny_unet_v3_MSELoss_5_classses_mean_std.pt",
            "2024_03_25/model_by_config_diffusion4_normal_mask_tiny_unet_v3_MSELoss_1_class_mean_std.pt",
            "2024_03_25/model_by_config_diffusion3_normal_mask_tiny_unet_v3_MSELoss_100_slices_mean_std.pt"            
            ]


add_names_list=[
            "_dataset_6_classes_normal_mask_mod_save_mask",
            "_dataset_5_classes_normal_mask_mod_save_mask",
            "_dataset_1_classes_normal_mask_mod_save_mask",
            "_dataset_1_classes_100_slices_normal_mask_mod_save_mask"
          ]
...
def mask_to_uint(img):
    img_min = img.min()
    img_max = img.max()
    ret_img=(img-img_min)*(255/(img_max-img_min))
