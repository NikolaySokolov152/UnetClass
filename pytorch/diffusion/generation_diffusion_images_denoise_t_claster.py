...
model_paths = [
            #"2024_02_29/model_by_config_diffusion3_tiny_unet_v3_MSELoss_old_repit.pt",
            #"2024_02_29/model_by_config_diffusion4_tiny_unet_v3_MSELoss_1_class.pt",
            #"2024_02_29/model_by_config_diffusion2_tiny_unet_v3_MSELoss_5_classses.pt",
            "2024_02_29/model_by_config_diffusion_tiny_unet_v3_MSELoss_6_classes.pt"            
            ]
        ...
        for iter in tqdm.tqdm(range(n_pic), desc='sampling loop time step', total=n_pic):
            ...
            for b in range(batch):
                for n in range(n_cannels):
                    ...
                    cv2.imwrite(os.path.join(channel_path, f"diffus_{img_index}.png"), img_to_uint(ready_batch_img[b,:,:,n])) 
                img_index+=1
