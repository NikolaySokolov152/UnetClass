...
def TestsMetricDir():
    ...
    list_CNN_num_class = [1, 5, 6]

    result_CNN_dir = [
                      #"data/result/agcwd/my_unet_multidata_pe69_bs9_1class_no_test_agcwd_v1_64",
                      "data/result/no_agcwd/my_unet_multidata_pe69_bs9_1class_no_test_v1_64",
                      #"data/result/agcwd/my_unet_multidata_pe69_bs9_5class_no_test_agcwd_v1_64",
                      "data/result/no_agcwd/my_unet_multidata_pe69_bs9_5class_no_test_v3_64",
                      #"data/result/agcwd/my_unet_multidata_pe69_bs9_6class_no_test_agcwd_v1_64",
                      "data/result/no_agcwd/my_unet_multidata_pe69_bs9_6class_no_test_v8_100ep_64"
                      ]


    result_CNN_json_name = ["CNN_1",
                            "CNN_1",
                            "CNN_5",
                            "CNN_5",
                            "CNN_6",
