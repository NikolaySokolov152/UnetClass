...
from prepare_data import saveBatchResultMask, tiledGen, prepare_list_batch_to_list_imgs
from reader import read_img
from read_data_transform_fun import to_0_1_format_img
...
def test_data(model_pipeliner,
    ...
    for imgs_batch, img_names_batch in slices_tqdm:
        ...
        if save_mask_dir is not None:
            saveBatchResultMask(save_mask_dir, ret_images_batch, img_names_batch, classnames=model_pipeliner.classnames)
