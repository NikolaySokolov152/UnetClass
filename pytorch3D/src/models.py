...
AVAILABLE_MODELS = ["unet", "tiny_unet", "tiny_unet_v3", "mobile_unet", "Lars76_unet",
                    "UNet", "Tiny_unet", "Tiny_unet_v3", "MobileUNet", "Attention_UNet", "attention_unet", "AttentionUNet"]
...
def getModelClassByName(model_name):
    if model_name in AVAILABLE_MODELS:
        ...
        if model_name in ("tiny_unet_v3", "Tiny_unet_v3"):
            return Tiny_unet_v3
        elif model_name in ("unet", "UNet"):
            return UNet
        elif model_name in ("tiny_unet", "Tiny_unet"):
            return Tiny_unet
        elif model_name in ("mobile_unet", "MobileUNet"):
            return MobileUNet
            ...
            return Lars76_unet
        elif model_name in ("Attention_UNet", "AttentionUNet", "attention_unet"):
